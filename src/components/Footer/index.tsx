        ...
        <div className="mt-5 flex items-center justify-center gap-4">
          {socialLinks.map((link) => (
            <a
              ...
              className="inline-flex min-h-[44px] min-w-[44px] items-center justify-center rounded-lg p-2.5 text-nurture-cream transition hover:bg-nurture-cream/10 hover:text-nurture-gold"
            >
