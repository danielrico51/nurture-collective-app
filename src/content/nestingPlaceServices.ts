...
export const NESTING_PLACE_SERVICE_AREA =
  "Based in Northern New Jersey & the Lower Hudson Valley — welcoming families everywhere";

export const NESTING_PLACE_PRACTICE_SUMMARY =
  "The Nesting Place is a Maternal Wellness and postpartum support practice welcoming families everywhere. We provide experienced, evidence-based birth doula support, overnight newborn care, postpartum support, lactation support, and prenatal massage to help families feel confident and supported during pregnancy, labor, and the early weeks at home with their newborn.";
