...
#   CLASS_REGISTRATION_VENMO_PROFILE_URL=https://www.venmo.com/u/thenestingplace
...
VENMO_PROFILE_URL="${CLASS_REGISTRATION_VENMO_PROFILE_URL:-https://www.venmo.com/u/thenestingplace}"
...
jq \
  ...
  . + {
    ...
    "CLASS_REGISTRATION_VENMO_PROFILE_URL": $venmoProfile,
...
echo "  CLASS_REGISTRATION_VENMO_PROFILE_URL=${VENMO_PROFILE_URL}"
