...
#   CLIENT_INVOICE_VENMO_PROFILE_URL=https://www.venmo.com/u/thenestingplace
#   CLIENT_INVOICE_ZELLE_HANDLE=@thenestingplace
...
VENMO_PROFILE_URL="${CLIENT_INVOICE_VENMO_PROFILE_URL:-https://www.venmo.com/u/thenestingplace}"
ZELLE_HANDLE="${CLIENT_INVOICE_ZELLE_HANDLE:-${VENMO_HANDLE}}"
...
jq \
  ...
  --arg venmoProfile "$VENMO_PROFILE_URL" \
  --arg zelleHandle "$ZELLE_HANDLE" \
  ...
  . + {
    ...
    "CLIENT_INVOICE_VENMO_PROFILE_URL": $venmoProfile,
    "CLIENT_INVOICE_ZELLE_HANDLE": $zelleHandle,
...
echo "  CLIENT_INVOICE_VENMO_PROFILE_URL=${VENMO_PROFILE_URL}"
echo "  CLIENT_INVOICE_ZELLE_HANDLE=${ZELLE_HANDLE}"
