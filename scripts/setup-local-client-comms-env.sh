...
QBO_BIRTH_SERVICES_ITEM_ID="$(read_var QBO_BIRTH_SERVICES_ITEM_ID)"
QBO_POSTPARTUM_SUPPORT_ITEM_ID="$(read_var QBO_POSTPARTUM_SUPPORT_ITEM_ID)"
QBO_OTHER_OPERATION_INCOME_ITEM_ID="$(read_var QBO_OTHER_OPERATION_INCOME_ITEM_ID)"
QBO_DEPOSIT_ITEM_ID="$(read_var QBO_DEPOSIT_ITEM_ID)"
...

{
  ...
  [[ -n "$QBO_BIRTH_SERVICES_ITEM_ID" ]] && echo "QBO_BIRTH_SERVICES_ITEM_ID=${QBO_BIRTH_SERVICES_ITEM_ID}"
  [[ -n "$QBO_POSTPARTUM_SUPPORT_ITEM_ID" ]] && echo "QBO_POSTPARTUM_SUPPORT_ITEM_ID=${QBO_POSTPARTUM_SUPPORT_ITEM_ID}"
  [[ -n "$QBO_OTHER_OPERATION_INCOME_ITEM_ID" ]] && echo "QBO_OTHER_OPERATION_INCOME_ITEM_ID=${QBO_OTHER_OPERATION_INCOME_ITEM_ID}"
  [[ -n "$QBO_DEPOSIT_ITEM_ID" ]] && echo "QBO_DEPOSIT_ITEM_ID=${QBO_DEPOSIT_ITEM_ID}"
